  ...
  return (
    ...
    className='section'>
        ...
        <div className='mb-12 lg:mb-0 lg:flex lg: flex-col'>   
            ...
            <p className='text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]'>Reach out to me at</p>
            
            <div className='flex item gap-2 mt-auto'>
                {socialLinks.map(({ href, icon}, key) => (
                    <a 
                    key={key}
                    href={href}
                    target='_blank'
                    className='w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:text-zinc-950 active:bg-zinc-50/80'
                    >
                        {icon}
                    </a>
                ))}
                ...
                <form 
                action="https://getform.io/f/alllynxa"
                method='POST'
                className='xl:pl-10 2xl:pl-20'>
                    ...
                    <div className='md:grid md:items-center md:grid-cols-2 md:gap-2'>
                        <div className='mb-4'>
                            ...
                            <input type="text" name='name' id='name' autoComplete='name' required placeholder='Mihir Hebalkar' className='text-field' />
                        </div>

                        <div className='mb-4'>
                            <label htmlFor="email" className='label'>Email</label>

                            <input type="email" name='email' id='email' autoComplete='email' required placeholder='mihir@example.com' className='text-field' />
                        </div> 
